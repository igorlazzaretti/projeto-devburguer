...
:man_technologist:Seed DevBurguer
Update | Atualizando Comentários e Readme

-->

## Seed DevBurguer API - DevClub
...
Essa aplicação backend faz parte do projeto final do curso MBA FullStack do DevClub.

Este projeto é responsável por popular (realizar o "seed") o banco de dados PostgreSQL com os dados iniciais dos produtos — como nome, imagem e custo — que serão ofertados na aplicação.
...
<div align="center">
  ...
  <img src="https://images.seeklogo.com/logo-png/33/1/axios-logo-png_seeklogo-339659.png"
    title="Axios" alt="Axios" width="70" height="65"/>&nbsp;
  <img src="https://devicon-website.vercel.app/api/javascript/original.svg"
    title="Javascript" alt="Javascript" width="70" height="65"/>&nbsp;
  <img src="https://devicon-website.vercel.app/api/linux/original.svg"
    title="File System" alt="File System" width="70" height="65"/>&nbsp;
...
As instruções estão no arquivo instrucoes.md
