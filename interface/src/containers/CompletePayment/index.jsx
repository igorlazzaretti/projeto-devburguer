...
export function CompletePayment() {
  ...
  return (
    ...
    <Container>
      ...
      <StatusText>{STATUS_CONTENT_MAP[status].text}</StatusText>
      {intentId && <DetailsTable>
        <table>
          <tbody>
            <tr>
      ...
      {intentId && <DetailsLink href={`https://dashboard.stripe.com/payments/${intentId}`} rel="noopener noreferrer" target="_blank">Veja Detalhes do Pagamento
